...
bd-conf:
	mysql -u root -p --execute="drop database if exists SME; create database SME; drop user if exists 'estudante'; create user 'estudante' identified by 'estudante2019'; grant all privileges on SMS.* to 'estudante';"
